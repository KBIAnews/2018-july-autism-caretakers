...
**TKTK: Describe 2018-july-autism-caretakers here.**
...
```
cd 2018-july-autism-caretakers
mkvirtualenv 2018-july-autism-caretakers
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1toNtYT7_Pzfveb3P3ZaTUI8_H3Fx1wrUwSkMGK8rDHg#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1toNtYT7_Pzfveb3P3ZaTUI8_H3Fx1wrUwSkMGK8rDHg', file_path)
    data = Copy(file_path)
...
```
workon 2018-july-autism-caretakers
fab render
```
...
```
* * * * * ubuntu bash /home/ubuntu/apps/2018_july_autism_caretakers/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|2018-july-autism-caretakers|tweet|`location`||
|2018-july-autism-caretakers|facebook|`location`||
|2018-july-autism-caretakers|email|`location`||
|2018-july-autism-caretakers|new-comment||
|2018-july-autism-caretakers|open-share-discuss||
|2018-july-autism-caretakers|close-share-discuss||
|2018-july-autism-caretakers|summary-copied||
|2018-july-autism-caretakers|featured-tweet-action|`action`|
|2018-july-autism-caretakers|featured-facebook-action|`action`|
